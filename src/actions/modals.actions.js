...
export const openModal =
  (modalNameInReducer, statusScroll, params) => (dispatch) => {
...
export const openTokenSelect = (params) => (dispatch) =>
  dispatch(openModal("isTokenSelect", "hideScroll", params));

export const closeTokenSelect = (params) => (dispatch) =>
  dispatch(closeModal("isTokenSelect", "addScroll"));
