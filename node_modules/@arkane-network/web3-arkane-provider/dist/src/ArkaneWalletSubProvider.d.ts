...
import { AuthenticationOptions, AuthenticationResult } from '@arkane-network/arkane-connect/dist/src/connect/connect';
import { Account } from '@arkane-network/arkane-connect/dist/src/models/Account';
export declare class ArkaneWalletSubProvider extends BaseWalletSubprovider {
    readonly arkaneConnect: ArkaneConnect;
    private wallets;
    options: ArkaneSubProviderOptions;
