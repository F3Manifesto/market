...
export declare class BuildSimpleTransactionRequest extends BuildTransferRequestBase implements BuildTransferRequestDto {
    static fromData(requestData: BuildTransferRequestDto): BuildSimpleTransactionRequest;
    value?: number;
    data?: string;
