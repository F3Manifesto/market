...
export declare class BuildGasTransferRequest extends BuildTransferRequestBase implements BuildGasTransferRequestDto {
    value: number;
    static fromData(data: BuildGasTransferRequestDto): BuildGasTransferRequest;
