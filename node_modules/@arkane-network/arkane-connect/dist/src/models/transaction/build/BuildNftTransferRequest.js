...
var BuildNftTransferRequest = /** @class */ (function (_super) {
    ...
    function BuildNftTransferRequest(walletId, to, secretType, tokenAddress, tokenId, from, alias, network) {
    ...
    BuildNftTransferRequest.fromData = function (requestData) {
        var walletId = requestData.walletId, to = requestData.to, secretType = requestData.secretType, tokenAddress = requestData.tokenAddress, tokenId = requestData.tokenId, from = requestData.from, alias = requestData.alias, network = requestData.network;
